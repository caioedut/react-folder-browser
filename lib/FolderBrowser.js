...
function FolderBrowser(props) {
  ...
  return _react["default"].createElement("div", {
    ...
    onChange: function onChange(e) {
      ...
      var exists = data.find(function (_ref) {
        var name = _ref.name;
    ...
    }, file.loading && _react["default"].createElement("b", null, "Enviando..."), file.error && _react["default"].createElement("div", null, _react["default"].createElement("b", null, "Falha no envio"))), _react["default"].createElement("td", {
      className: "folder-browser-nowrap"
